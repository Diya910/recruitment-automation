...
from chat_with_summarization.settings import config_settings, LLMServiceEnum
...
def get_chat_llm(
    ...
    try:
        if config_settings.LLM_SERVICE_TYPE == LLMServiceEnum.OPENAI.value:
            return ChatOpenAI(
        ...
        elif config_settings.LLM_SERVICE_TYPE == LLMServiceEnum.OLLAMA.value:
            return ChatOllama(
                model=config_settings.OLLAMA_MODEL_SETTINGS.get(
                    model_key, None
                ),
        ...
        elif config_settings.LLM_SERVICE_TYPE == LLMServiceEnum.AWS_BEDROCK.value:
